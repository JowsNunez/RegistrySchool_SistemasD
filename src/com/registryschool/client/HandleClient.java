...
import com.registryschool.persists.Students;
import com.registryschool.interpret.RegistryDataInterpreter;
...
public class HandleClient implements Runnable {
    ...
    public void connect() {
        try {
            this.client.getOut().writeUTF("CONNECT:REGSYSTEM"); // Envía un mensaje de conexión al servidor
    ...
    private void receiveData(String msg) {
        ...
        if (msg.startsWith("TOKEN:")) {
            ...
            Map<String, Object> data = new RegistryDataInterpreter().decode(msg);
            manipulateData(data);
        } else {
...
//        
        try {
            String msg = new RegistryDataInterpreter().encode(action, data, "TEACHERSYSTEM", "REGSYSTEM");
